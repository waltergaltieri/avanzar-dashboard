...
function anyArbitraryBuilder(constraints) {
    ...
    return (0, letrec_1.letrec)((tie) => ({
        ...
        set: (0, set_1.set)(tie('anything'), { maxLength: maxKeys, size, depthIdentifier }),
        map: (0, oneof_1.oneof)((0, map_1.map)(tie('keys'), tie('anything'), { maxKeys, size, depthIdentifier }), (0, map_1.map)(tie('anything'), tie('anything'), { maxKeys, size, depthIdentifier })),
